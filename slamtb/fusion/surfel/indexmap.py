...
from slamtb.camera import RTCamera, normal_transform_matrix
from slamtb._cslamtb import IndexMap
...
class ModelIndexMapRaster(_BaseIndexMapRaster):
    ...
    def __init__(self, surfel_model, use_color=False):
        """Args:
            ...
            surfel_model
             (:obj:`slamtb.fusion.surfel.model.SurfelModel`): Surfel model.
    ...
    def raster(self, proj_matrix, rt_cam, width, height,
        ...
        Args:
            ...
            rt_cam (:obj:`slamtb.camera.RTCamera`): Viewpoint camera transformation.
