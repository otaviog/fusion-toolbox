...
#include <slamtb/aabb.hpp>

TEST_CASE("AABB", "[aabb]") {
  slamtb::AABB box2(Eigen::Vector3f(2, 1, 3), Eigen::Vector3f(5, 4, 9));
  ...
  slamtb::AABB box3(Eigen::Vector3f(-0.0931465998, 0.107758701, 0.000578399748),
